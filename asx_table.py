...
df = df.assign(ASX_CLASS="Equity - Australia")
names = ["Equity - Australian Small/Mid Cap", "Equity - Australian Sectors", "Equity - Australia Strategy",
         "Equity - Global", "Equity - Global Sectors", "Equity - Global Strategy", "Equity - Global Factors",
         "Equity - Emerging Markets", "Equity - Asia", "Equity - China", "Equity - Europe", "Equity - Japan",
         "Equity - South Korea", "Equity - United Kingdom", "Equity - USA", "Equity - India", "Equity - Infrastructure",
...
df = df[
    ["ASX_CLASS", "ASX Code", "Type", "Exposure", "Benchmark", "Management Cost %", "Outperf' Fee", "Admission Date"]]
df.columns = ["ASX_CLASS", "CODE", "TYP", "NAME", "BENCHMARK", "MER%", "OF", "AGE(Y)"]

...
# AU Coinbase supported, 58 as of 07-05-2021, Celo is CGLD on Coinbase, CELO elsewhere.
coinbaseAU = ["1INCH", "AAVE", "ADA", "ALGO", "ANKR", "ATOM", "BAL", "BAND", "BAT", "BCH", "BNT", "BTC", "CELO", "COMP",
              "CRV", "CTSI", "CVC", "DAI", "DASH", "DNT", "ENJ", "EOS", "ETC", "ETH", "FIL", "FORTH", "GRT", "ICP",
              "KNC", "LINK", "LRC", "LTC", "MANA", "MATIC", "MIR", "MKR", "NKN", "NMR", "NU", "OGN", "OMG", "OXT",
              "REN", "REP", "RLC", "SKL", "SNX", "STORJ", "SUSHI", "TRB", "UMA", "UNI", "WBTC", "XLM", "XTZ", "YFI",
              "ZEC", "ZRX"]
...
df3.columns = ["DATE_TIME", "TYPE", "CODE", "QUANTITY", "SPOT($)", "COIN($)", "TOTAL($)", "FEE($)", "NOTES"]
